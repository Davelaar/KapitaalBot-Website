...
import { toekomstvisieArticleByLocale } from "@/lib/toekomstvisie-article";
...
/** Personal future-vision essay — structured for SEO/RAG (headings, lists). */
export function ToekomstvisieArticleBody({ locale }: { locale: Locale }) {
  const blocks = toekomstvisieArticleByLocale[locale];
  return (
    <div className="wat-is-article" id="article-body" data-page-kind="toekomstvisie">
