...
import { bitvavoKrakenArticleByLocale } from "@/lib/bitvavo-kraken-article";
...
/** Long-form comparison Bitvavo vs Kraken — structured for SEO/RAG (headings, lists). */
export function BitvavoKrakenArticleBody({ locale }: { locale: Locale }) {
  const blocks = bitvavoKrakenArticleByLocale[locale];
  return (
    <div className="wat-is-article" id="article-body" data-page-kind="bitvavo-kraken-compare">
