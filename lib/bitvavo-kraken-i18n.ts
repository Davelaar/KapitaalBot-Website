...
export const bitvavoKrakenStrings: Record<Locale, Record<string, string>> = {
  ...
  fr: {
    ...
    "bk.footer.sources": "Sources",
    "bk.footer.disclaimerBody":
      "AFM, ESMA (registres MiCA) ; communications publiques de Bitvavo, Kraken, Coinbase, OKX, Crypto.com et Bybit. Avant publication ou usage, revérifiez le registre crypto de l’AFM et le registre MiCA intérimaire de l’ESMA — les enregistrements et la disponibilité des produits peuvent évoluer. Pas un conseil juridique ni d’investissement.",
  },
};
